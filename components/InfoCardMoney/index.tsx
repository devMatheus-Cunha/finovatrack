...
const InfoCardMoney = ({ infoData, title, contentAction }: InfoCardProps) => {
 return (
  <div className="w-[25%] h-[11vh] focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center  px-4 py-2.5 dark:bg-gray-700  dark:focus:ring-gray-700">
