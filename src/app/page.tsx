      ...
      <main className="container mx-auto p-4 flex-grow">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300">
            ...
            <li>
              <strong>Controle de múltiplas moedas:</strong> Defina a moeda
              principal da sua conta para a conversão automática de valores. Por
              exemplo, se sua moeda principal é o Real (BRL) e você fez uma
              entrada de 10.000 BRL e teve gastos de 300 BRL e 1.000 EUR, nossa
              plataforma converterá automaticamente os valores de EUR para BRL
              com base na cotação atual. Você poderá visualizar o total de
              gastos em EUR convertido para BRL e o total de gastos somando BRL
              e EUR.
            </li>
          </ul>
        </section>
