...
function ConfirmSaveReportModal({ onSubmit, onCancel, initialData }: IConfirmSaveReportModal) {
  return (
    <div
      className="absolute top-1/2 left-1/2 -translate-x-1/3 -translate-y-1/2 z-50 w-1/4"
    >
