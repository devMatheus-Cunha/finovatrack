...
import { formatCurrency } from '../control/parts/utils';
     ...
     <div className='w-[95%]'>
      {
       data ? (
        <div className='flex flex-col gap-4'>
         <h1 className='text-xl'>Relatório referente ao período <span className='italic'>{data?.period}</span></h1>
         <div className='flex gap-4'>
          ...
          <h1 className='dark:text-gray-300'>Total Investido: <span className='italic dark:text-white'>{data.totalInvested}</span></h1>
          <h1 className='dark:text-gray-300'>Cotação Usada: <span className='italic dark:text-white'>{data.quatation}</span></h1>
         </div>
